...
export default function App() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      {/* Header */}
      <div className="relative bg-gradient-to-r from-pink-600 via-rose-600 to-purple-600 text-white py-16 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl text-pink-100 mb-2">
            كل التفاصيل اللي محتاجينها ليوم العمر 💐
          </p>
          <div className="flex items-center justify-center gap-3 mt-6 text-xl">
            <div className="bg-white bg-opacity-20 px-6 py-3 rounded-full backdrop-blur-sm">
              📝 كتب الكتاب
            </div>
            <div className="bg-white bg-opacity-20 px-6 py-3 rounded-full backdrop-blur-sm">
              💒 يوم الفرح
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-4xl font-bold">كتب الكتاب</h2>
                    <p className="text-pink-100 text-lg mt-2">الخطوة الأولى المباركة 💫</p>
                  </div>
                </div>
                <div className="text-center bg-white bg-opacity-20 px-6 py-4 rounded-2xl backdrop-blur-sm">
                  <div className="text-4xl font-bold">{getProgress(ktbElKitabItems, 'ktb')}%</div>
                  <div className="text-sm text-pink-100">مكتمل</div>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                      ...
                      {isChecked('ktb', index) ? (
                        ...
                        <div className="w-7 h-7 border-2 border-pink-400 rounded-lg"></div>
                      )}
                    </div>
        ...
        <div className="mb-12">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-purple-200">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-4xl font-bold">يوم الفرح</h2>
                    <p className="text-purple-100 text-lg mt-2">اليوم الأجمل في العمر 🎊</p>
                  </div>
                </div>
                <div className="text-center bg-white bg-opacity-20 px-6 py-4 rounded-2xl backdrop-blur-sm">
                  <div className="text-4xl font-bold">{getProgress(yomElfarahItems, 'farah')}%</div>
                  <div className="text-sm text-purple-100">مكتمل</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
                  ...
                  >
                    <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                      ...
                      {isChecked('farah', index) ? (
                        ...
                        <div className="w-7 h-7 border-2 border-purple-400 rounded-lg"></div>
                      )}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        {item.price && (
                          <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white px-4 py-2 rounded-xl font-bold text-lg shadow-md">
                            {item.price}
                          </div>
                        )}
                      </div>
              ...
              {/* Total Cost */}
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-4 border-yellow-300 rounded-2xl p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="text-4xl">💰</span>
                    <span className="text-2xl font-bold text-gray-800">إجمالي التكاليف المحددة</span>
                  </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-rose-200">
          <div className="bg-gradient-to-r from-rose-500 to-pink-500 text-white p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-4xl font-bold">سيناريو يوم الفرح</h2>
                <p className="text-rose-100 text-lg mt-2">البرنامج اليومي خطوة بخطوة ⏰</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute right-8 top-8 bottom-8 w-1 bg-gradient-to-b from-pink-400 via-rose-400 to-purple-400"></div>
                ...
                {[
                  ...
                  <div key={index} className="relative flex items-start gap-6">
                    ...
                    <div className="relative z-10 flex-shrink-0">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center text-white shadow-xl border-4 border-white">
                        {step.icon}
                      </div>
                    </div>

                    {/* Content */}
                    <div className="flex-1 bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 border-2 border-pink-200 shadow-lg hover:shadow-xl transition-shadow">
        ...
        {/* Final Message */}
        <div className="mt-12 bg-gradient-to-r from-pink-500 via-rose-500 to-purple-500 rounded-3xl p-8 text-white text-center shadow-2xl">
          <Heart className="w-16 h-16 mx-auto mb-4 animate-pulse" />
          <h3 className="text-3xl font-bold mb-3">مبروك مقدماً! 🎉</h3>
